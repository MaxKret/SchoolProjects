# -*- coding: utf-8 -*-
"""aggregation final.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1llU_rb6toqBTrMb_qFEyiV9gDwuuw7P2

# Aggregation Lab

## Group: &lt; Lab Group 31 &gt;

### Members: &lt; Jack Rickman, Max Kretschmer &gt; 
...
alt.Chart(temps).mark_bar().encode(
    color=alt.Color('temp:Q', bin=True),
    y=alt.Y('month(date):T'),
    x=alt.X('count():Q', axis=alt.Axis(format='%'), stack='normalize'))

alt.Chart(temps).mark_boxplot(extent='min-max').encode(
    x='month(date):T',
    y='temp:Q'
)

"""I believe that the box and whiskers plot shows the most useful information and is the most visually pleasing and intuitive idiom for showing this information. I especially like being able to see the ranges, with the boxes and whiskers, and the median easily for each month, as it makes it much easier to visualize and understand the data."""